 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__16127){
var vec__16128 = p__16127;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16128,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16128,(1),null);
return ((function (vec__16128,tag,re){
return (function (s){
...
var len__10195__auto___16133 = arguments.length;
var i__10196__auto___16134 = (0);
while(true){
if((i__10196__auto___16134 < len__10195__auto___16133)){
args__10202__auto__.push((arguments[i__10196__auto___16134]));

var G__16135 = (i__10196__auto___16134 + (1));
i__10196__auto___16134 = G__16135;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__10203__auto__);
});
...
return (p1__16131_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__16131_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__16131_SHARP_.call(null,s));
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq16132){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16132));
});
...
var map__16136 = temp__5455__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16136__$1,cljs.core.cst$kw$tag);
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16136__$1,cljs.core.cst$kw$chunk);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16136__$1,cljs.core.cst$kw$size);
var G__16139 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__16140 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__16138 = tag;
