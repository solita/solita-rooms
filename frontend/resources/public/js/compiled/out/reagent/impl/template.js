...
return cljs.core._write(writer__9588__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17133 = o;
(G__17133[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__17134__delegate = function (args){
...
while (G__17135__i < G__17135__a.length) {G__17135__a[G__17135__i] = arguments[G__17135__i + 0]; ++G__17135__i;}
  args = new cljs.core.IndexedSeq(G__17135__a,0,null);
} 
return G__17134__delegate.call(this,args);};
G__17134.cljs$lang$maxFixedArity = 0;
G__17134.cljs$lang$applyTo = (function (arglist__17136){
var args = cljs.core.seq(arglist__17136);
return G__17134__delegate(args);
});
...
var G__17139 = jsprops;
(G__17139["defaultValue"] = value);

(G__17139["onChange"] = ((function (G__17139,v,value,on_change){
return (function (p1__17138_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17138_SHARP_);
});})(G__17139,v,value,on_change))
);
...
var vec__17142 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17142,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17142,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17142,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___17146 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___17146 == null)){
} else {
var key_17147 = temp__5461__auto___17146;
(jsprops["key"] = key_17147);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17148 = reagent.impl.template.__GT_NativeWrapper();
(G__17148["name"] = c);
...
var G__17149 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17149) : reagent.impl.template.as_element.call(null,G__17149));
} else {
...
var len__10195__auto___17154 = arguments.length;
var i__10196__auto___17155 = (0);
while(true){
if((i__10196__auto___17155 < len__10195__auto___17154)){
args__10202__auto__.push((arguments[i__10196__auto___17155]));

var G__17156 = (i__10196__auto___17155 + (1));
i__10196__auto___17155 = G__17156;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__10203__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17152){
var G__17153 = cljs.core.first(seq17152);
var seq17152__$1 = cljs.core.next(seq17152);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17153,seq17152__$1);
});
...
break;
default:
var G__17159 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17159;
continue;
...
var n__9961__auto___17161 = a.length;
var i_17162 = (0);
while(true){
if((i_17162 < n__9961__auto___17161)){
(a[i_17162] = reagent.impl.template.as_element((a[i_17162])));

var G__17163 = (i_17162 + (1));
i_17162 = G__17163;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__9961__auto___17164 = a.length;
var i_17165 = (0);
while(true){
if((i_17165 < n__9961__auto___17164)){
var val_17166 = (a[i_17165]);
if((cljs.core.vector_QMARK_(val_17166)) && ((reagent.impl.template.key_from_vec(val_17166) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17165] = reagent.impl.template.as_element(val_17166));
...
var ctx = ({});
var vec__17168 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17168,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17168,(1),null);
...
var G__17171 = (cljs.core.count(argv) - first_child);
switch (G__17171) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17171){
