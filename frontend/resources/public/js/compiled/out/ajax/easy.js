...
var G__19646 = format;
var G__19646__$1 = (((G__19646 instanceof cljs.core.Keyword))?G__19646.fqn:null);
switch (G__19646__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__19648 = cljs.core.second(format);
var G__19649 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__19648,G__19649) : ajax.easy.keyword_response_format_element.call(null,G__19648,G__19649));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__19650 = format;
var G__19650__$1 = (((G__19650 instanceof cljs.core.Keyword))?G__19650.fqn:null);
switch (G__19650__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19652_SHARP_){
return ajax.easy.keyword_response_format_element(p1__19652_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__19653){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19654__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19654__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19654__$1,cljs.core.cst$kw$finally);
var h = (function (){var or__8916__auto__ = handler;
...
var e = (function (){var or__8916__auto__ = error_handler;
if(cljs.core.truth_(or__8916__auto__)){
return or__8916__auto__;
} else {
...
return ((function (h,e,map__19654,map__19654__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__19656){
var vec__19657 = p__19656;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19657,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19657,(1),null);
var fexpr__19660_19661 = (cljs.core.truth_(ok)?h:e);
(fexpr__19660_19661.cljs$core$IFn$_invoke$arity$1 ? fexpr__19660_19661.cljs$core$IFn$_invoke$arity$1(result) : fexpr__19660_19661.call(null,result));
...
;})(h,e,map__19654,map__19654__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__19662){
...
var opts = map__19663__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19663__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19663__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19663__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19663__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19663__$1,cljs.core.cst$kw$body);

var needs_format = ((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET"));
var rf = (cljs.core.truth_((function (){var or__8916__auto__ = format;
if(cljs.core.truth_(or__8916__auto__)){
return or__8916__auto__;
} else {
return needs_format;
