...
var or__30179__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33899 = {"detail":data};
return obj33899;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30167__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30167__auto__)){
var and__30167__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__33906 = cljs.core._EQ_;
var expr__33907 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33906.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33907))){
return ((function (pred__33906,expr__33907){
return (function (p1__33900_SHARP_){
return console.warn(p1__33900_SHARP_);
});
;})(pred__33906,expr__33907))
} else {
if(cljs.core.truth_(pred__33906.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33907))){
return ((function (pred__33906,expr__33907){
return (function (p1__33901_SHARP_){
return console.debug(p1__33901_SHARP_);
});
;})(pred__33906,expr__33907))
} else {
if(cljs.core.truth_(pred__33906.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33907))){
return ((function (pred__33906,expr__33907){
return (function (p1__33902_SHARP_){
return console.error(p1__33902_SHARP_);
});
;})(pred__33906,expr__33907))
} else {
return ((function (pred__33906,expr__33907){
return (function (p1__33903_SHARP_){
return console.log(p1__33903_SHARP_);
});
;})(pred__33906,expr__33907))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33910){
...
var eval_fn = cljs.core.get.call(null,map__33911__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33913_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33915,(0),null);
...
if(cljs.core.truth_((function (){var and__30167__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__30167__auto__)){
...
}catch (e33920){if((e33920 instanceof Error)){
var e = e33920;
return not_found;
} else {
throw e33920;
...
//# sourceMappingURL=utils.js.map?rel=1523638712226
