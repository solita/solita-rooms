...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__55544){
var map__55545 = p__55544;
var map__55545__$1 = ((((!((map__55545 == null)))?((((map__55545.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55545.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55545):map__55545);
var handler = cljs.core.get.call(null,map__55545__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__30179__auto__ = p1__55547_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__55548){
var map__55549 = p__55548;
var map__55549__$1 = ((((!((map__55549 == null)))?((((map__55549.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55549.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55549):map__55549);
var request = map__55549__$1;
var interceptors = cljs.core.get.call(null,map__55549__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__30179__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__30179__auto__)){
return or__30179__auto__;
} else {
...
//# sourceMappingURL=simple.js.map?rel=1523638674483
