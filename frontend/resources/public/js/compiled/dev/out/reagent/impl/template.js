...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30850__auto__,writer__30851__auto__,opt__30852__auto__){
return cljs.core._write.call(null,writer__30851__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__55890 = o;
(G__55890[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__55891__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__55891 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55892__i = 0, G__55892__a = new Array(arguments.length -  0);
while (G__55892__i < G__55892__a.length) {G__55892__a[G__55892__i] = arguments[G__55892__i + 0]; ++G__55892__i;}
  args = new cljs.core.IndexedSeq(G__55892__a,0,null);
} 
return G__55891__delegate.call(this,args);};
G__55891.cljs$lang$maxFixedArity = 0;
G__55891.cljs$lang$applyTo = (function (arglist__55893){
var args = cljs.core.seq(arglist__55893);
return G__55891__delegate(args);
});
G__55891.cljs$core$IFn$_invoke$arity$variadic = G__55891__delegate;
return G__55891;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__30167__auto__ = !((jsprops == null));
if(and__30167__auto__){
var and__30167__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__55896 = jsprops;
(G__55896["defaultValue"] = value);

(G__55896["onChange"] = ((function (G__55896,v,value,on_change){
return (function (p1__55895_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__55895_SHARP_);
});})(G__55896,v,value,on_change))
);
...
var vec__55899 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__55899,(0),null);
var id = cljs.core.nth.call(null,vec__55899,(1),null);
var class$ = cljs.core.nth.call(null,vec__55899,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___55903 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___55903 == null)){
} else {
var key_55904 = temp__5461__auto___55903;
(jsprops["key"] = key_55904);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__55905 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__55905["name"] = c);
...
var len__31458__auto___55910 = arguments.length;
var i__31459__auto___55911 = (0);
while(true){
if((i__31459__auto___55911 < len__31458__auto___55910)){
args__31465__auto__.push((arguments[i__31459__auto___55911]));

var G__55912 = (i__31459__auto___55911 + (1));
i__31459__auto___55911 = G__55912;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31466__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq55908){
var G__55909 = cljs.core.first.call(null,seq55908);
var seq55908__$1 = cljs.core.next.call(null,seq55908);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__55909,seq55908__$1);
});
...
break;
default:
var G__55915 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__55915;
continue;
...
var n__31224__auto___55917 = a.length;
var i_55918 = (0);
while(true){
if((i_55918 < n__31224__auto___55917)){
(a[i_55918] = reagent.impl.template.as_element.call(null,(a[i_55918])));

var G__55919 = (i_55918 + (1));
i_55918 = G__55919;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31224__auto___55920 = a.length;
var i_55921 = (0);
while(true){
if((i_55921 < n__31224__auto___55920)){
var val_55922 = (a[i_55921]);
if((cljs.core.vector_QMARK_.call(null,val_55922)) && ((reagent.impl.template.key_from_vec.call(null,val_55922) == null))){
(o["no-key"] = true);
} else {
}

(a[i_55921] = reagent.impl.template.as_element.call(null,val_55922));

var G__55923 = (i_55921 + (1));
i_55921 = G__55923;
continue;
} else {
}
...
var ctx = ({});
var vec__55924 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__55924,(0),null);
var derefed = cljs.core.nth.call(null,vec__55924,(1),null);
...
var G__55927 = (cljs.core.count.call(null,argv) - first_child);
switch (G__55927) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__55927){
...
//# sourceMappingURL=template.js.map?rel=1523638675277
